...
const sections = [
  [
    ...
    "Create an account with an email address and a password of at least 10 characters. New accounts receive 19 welcome credits (6⅓ tokens). Your lessons are private to your signed-in account.",
  ],
  [
