...
const sections = [
  [
    "Welcome credits",
    "A new account receives 5 free note sections. One token covers 3 sections; one section consumes ⅓ token; longer sections may print on multiple sheets. Planning and PDF re-downloads do not subtract credits.",
  ],
  [
